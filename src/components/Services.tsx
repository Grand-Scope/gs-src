                ...
                <div>
                    {services.map((service, index) => (
                        <motion.div 
                            ...
                            className="group border-t border-white/20 last:border-b py-10 px-4 flex items-center justify-between cursor-pointer hover:bg-white/5 transition-colors duration-300"
                        >
                            <div className="flex items-center gap-8 md:gap-12 flex-1">
                                <span className="font-mono text-[13px] font-bold text-orange w-12 shrink-0">{service.id}</span>
                            ...
                            <div className="text-orange shrink-0 ml-4 opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 group-hover:-rotate-45 transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)]">
