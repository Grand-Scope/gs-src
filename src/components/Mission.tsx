...
const StarBurst = () => (
    <svg viewBox="0 0 100 100" fill="none" className="inline-block h-[10vw] w-auto shrink-0 self-center">
        <circle cx="50" cy="50" r="35" stroke="currentColor" strokeWidth="2" className="text-black/15" />
        <line x1="50" y1="5" x2="50" y2="95" stroke="currentColor" strokeWidth="1.5" className="text-black/10" />
        <line x1="5" y1="50" x2="95" y2="50" stroke="currentColor" strokeWidth="1.5" className="text-black/10" />
        <line x1="15" y1="15" x2="85" y2="85" stroke="currentColor" strokeWidth="1.5" className="text-black/10" />
        <line x1="85" y1="15" x2="15" y2="85" stroke="currentColor" strokeWidth="1.5" className="text-black/10" />
    </svg>
);
...
const DiamondDot = () => (
    <svg viewBox="0 0 40 40" fill="none" className="inline-block h-[3vw] w-auto shrink-0 self-center mx-[1vw]">
        <rect x="12" y="12" width="16" height="16" rx="2" transform="rotate(45 20 20)" fill="currentColor" className="text-black/20" />
    </svg>
);
...
export default function Mission() {
    ...
    return (
        <div id="mission" ref={sectionRef} className="relative z-10 bg-brand-500 overflow-hidden">
                ...
                >
                    ...
                    >
                        <div className="grid lg:grid-cols-2 gap-20 items-start">
                            <div>
                                <span className="font-mono text-[11px] font-bold uppercase text-black/50 block mb-6">
                                    [ 001 — MANIFESTO ]
                                </span>
                    ...
                    <span className="font-display text-[18vw] md:text-[14vw] text-black uppercase leading-none tracking-tighter shrink-0">
                        Transcending
                    </span>
                    <span className="inline-block w-[4vw] shrink-0" />
                    <Sparkle />
                    <span className="inline-block w-[4vw] shrink-0" />
                    <span className="font-display text-[14vw] md:text-[11vw] text-black uppercase leading-none tracking-tight shrink-0">
                        the
                    </span>
                    <span className="inline-block w-[4vw] shrink-0" />
                    <span className="font-display text-[16vw] md:text-[12vw] text-black uppercase leading-none tracking-tight shrink-0">
                        typical,
                    </span>
                    <span className="inline-block w-[4vw] shrink-0" />
                    <WavyCurve />
